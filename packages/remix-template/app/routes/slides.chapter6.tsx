import { ScrollableSlides } from "~/slides/chapter6/ScrollableSlides";
import { Link } from "react-router";

export const meta = () => {
  return [
    { title: "Kubernetes Patterns - Chapter 6 Slides" },
    { name: "description", content: "Kubernetes Patterns Chapter 6: Automated Placement Slides" },
  ];
};

export default function Chapter6Slides() {
  return (
