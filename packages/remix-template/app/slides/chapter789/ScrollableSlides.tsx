...
export function ScrollableSlides() {
  ...
  const slideTitles = [
    "Kubernetes Patterns - Chapters 7,8,9: Behavioral Patterns",
    "Part II Overview - Behavioral Patterns",
    "Chapter 7 - Batch Job: Problem",
    "Chapter 7 - Batch Job: Solution (Job Resource)",
    "Chapter 7 - Batch Job: Parallelism & Completions",
    "Chapter 7 - Batch Job: Completion Mode",
    "Chapter 7 - Batch Job: Discussion & More Information",
    "Chapter 8 - Periodic Job: Problem",
    "Chapter 8 - Periodic Job: Solution (CronJob Resource)",
    "Chapter 8 - Periodic Job: Schedule Syntax",
    "Chapter 8 - Periodic Job: Concurrency Policy",
    "Chapter 8 - Periodic Job: History Limits",
    "Chapter 8 - Periodic Job: Discussion & More Information",
    "Chapter 9 - Daemon Service: Problem",
    "Chapter 9 - Daemon Service: Solution (DaemonSet Resource)",
    "Chapter 9 - Daemon Service: Update Strategies",
    "Chapter 9 - Daemon Service: Node Selection",
    "Chapter 9 - Daemon Service: Discussion & More Information",
    "Chapter 10 - Singleton Service: Problem",
    "Chapter 10 - Singleton Service: Solution (StatefulSet with Single Replica)",
    "Chapter 10 - Singleton Service: Discussion & More Information"
  ];
  ...
  return (
    <div className="relative">
      ...
      <div className="fixed left-6 top-1/2 transform -translate-y-1/2 bg-white dark:bg-gray-800 rounded-lg shadow-xl p-4 w-64 z-20 hidden lg:block border border-gray-200 dark:border-gray-700">
        <h3 className="font-bold text-lg mb-3 text-gray-900 dark:text-white pb-2 border-b border-gray-200 dark:border-gray-700">Chapters 7,8,9: Behavioral Patterns</h3>
      ...
      <div id="mobile-toc" className="fixed inset-0 bg-black bg-opacity-50 z-30 hidden lg:hidden">
        <div className="absolute left-0 top-0 h-full w-80 bg-white dark:bg-gray-800 shadow-xl p-6 overflow-y-auto border-r border-gray-200 dark:border-gray-700">
          <div className="flex justify-between items-center mb-6">
            <h3 className="font-bold text-lg text-gray-900 dark:text-white">Chapters 7,8,9: Behavioral Patterns</h3>
            <button
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 ml-0 lg:ml-72">
        {Array.from({ length: 21 }, (_, i) => i + 1).map((slideNumber) => (
          <div
            key={slideNumber}
      ...
      <div className="fixed bottom-0 left-0 right-0 h-1 bg-gray-200 dark:bg-gray-700 z-20">
        <div
          ...
          style={{ width: `${(activeSlide / 21) * 100}%` }}
        ></div>
      </div>
    </div>
  );
