...
export function ScrollableSlides() {
  ...
  const slideTitles = [
    ...
    "Solution - 概述",
    "Solution - 探针类型介绍",
    "Process Health Checks (1/2)",
    "Process Health Checks (2/2)",
    "Liveness Probes - 概念",
    "Liveness Probes - 配置示例 (1/2)",
    "Liveness Probes - 配置示例 (2/2)",
    "Readiness Probes - 概念",
    "Readiness Probes - 配置示例",
    "Startup Probes - 概念",
    "Startup Probes - 配置示例",
    "Discussion - 可靠性影响 (1/2)",
    "Discussion - 可靠性影响 (2/2)",
    "Discussion - 最佳实践",
    "More Information",
    "总结 & Q&A"
  ];
  ...
  return (
    <div className="relative">
      ...
      <div className="fixed left-6 top-1/2 transform -translate-y-1/2 bg-white dark:bg-gray-800 rounded-lg shadow-xl p-4 w-64 z-20 hidden lg:block border border-gray-200 dark:border-gray-700">
        <h3 className="font-bold text-lg mb-3 text-gray-900 dark:text-white pb-2 border-b border-gray-200 dark:border-gray-700">Chapter 4: Health Probe</h3>
      ...
      <div id="mobile-toc" className="fixed inset-0 bg-black bg-opacity-50 z-30 hidden lg:hidden">
        <div className="absolute left-0 top-0 h-full w-80 bg-white dark:bg-gray-800 shadow-xl p-6 overflow-y-auto border-r border-gray-200 dark:border-gray-700">
          <div className="flex justify-between items-center mb-6">
            <h3 className="font-bold text-lg text-gray-900 dark:text-white">Chapter 4: Health Probe</h3>
            <button
