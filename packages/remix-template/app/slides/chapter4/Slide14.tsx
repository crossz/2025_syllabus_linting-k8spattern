export function Slide14() {
  return (
    <div className="slide-container">
      <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-6 pb-2 border-b border-gray-200 dark:border-gray-700">Startup Probes - 概念</h1>
      <div className="mb-8">
        <ul className="list-disc pl-8 mb-6 text-gray-700 dark:text-gray-300">
          <li>用于长初始化容器 (e.g., DB 迁移、加载 datasets)</li>
          <li>确保启动完成后激活其他探针</li>
        </ul>
