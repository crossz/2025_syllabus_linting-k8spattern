...
export function ScrollableSlides() {
  ...
  const slideTitles = [
    "Kubernetes Patterns - Chapter 5: Lifecycle Management",
    "章节概述 (1/2)",
    "章节概述 (2/2)",
    "Problem - 生命周期挑战 (1/2)",
    "Problem - 生命周期挑战 (2/2)",
    ...
    "PreStop Hook - 概念",
    "PreStop Hook - 配置示例",
    "Other Lifecycle Controls - 终止宽限期",
    "Other Lifecycle Controls - 重启策略",
    "Other Lifecycle Controls - 探针影响",
    "Discussion - 最佳实践 (1/2)",
    "Discussion - 最佳实践 (2/2) & 总结"
  ];
  ...
  return (
    <div className="relative">
      ...
      <div className="fixed left-6 top-1/2 transform -translate-y-1/2 bg-white dark:bg-gray-800 rounded-lg shadow-xl p-4 w-64 z-20 hidden lg:block border border-gray-200 dark:border-gray-700">
        <h3 className="font-bold text-lg mb-3 text-gray-900 dark:text-white pb-2 border-b border-gray-200 dark:border-gray-700">Chapter 5: Lifecycle Management</h3>
      ...
      <div id="mobile-toc" className="fixed inset-0 bg-black bg-opacity-50 z-30 hidden lg:hidden">
        <div className="absolute left-0 top-0 h-full w-80 bg-white dark:bg-gray-800 shadow-xl p-6 overflow-y-auto border-r border-gray-200 dark:border-gray-700">
          <div className="flex justify-between items-center mb-6">
            <h3 className="font-bold text-lg text-gray-900 dark:text-white">Chapter 5: Lifecycle Management</h3>
            <button
