export function Slide18() {
  return (
    <div className="slide-container">
      ...
      <h3 className="text-2xl mb-4">Other Lifecycle Controls - 探针影响</h3>
      <div className="mb-8">
        <ul className="list-disc pl-8 mb-6 text-gray-700 dark:text-gray-300">
          <li>Liveness/Readiness: 间接影响 (Chapter 4)</li>
          <li>Startup: 延迟其他探针</li>
        </ul>
        <div className="bg-blue-50 dark:bg-blue-900/30 border-l-4 border-blue-500 p-4 mb-6">
          <p className="text-blue-800 dark:text-blue-200 italic">
            <span className="italic font-medium">Liveness and Readiness Probes... indirectly influence lifecycle management...</span>
          </p>
        </div>
